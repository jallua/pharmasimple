...
popularity: 55
summary: 一种外用"维 A 酸类"祛痘药:作用于皮肤的视黄酸受体,让毛囊口的角质正常代谢脱落、不再堵塞毛孔,并减轻炎症,从而减少粉刺和痘痘;用于寻常痤疮。由高德美(Galderma)研发(达芙文)。
indications:
  - region: 美国
    regulator: FDA
    items:
...
target:
  name: 视黄酸受体(RAR)
  type: receptor
  role: 皮肤细胞核内的受体,调控角质细胞的分化与更新;调节得当,毛孔就不易被角质堵塞。
mechanism:
...
media:
  - type: animation
    ...
    alt: 动画演示外用维 A 酸类结合皮肤视黄酸受体,让角质正常更新脱落、毛孔通畅、炎症减轻,痘痘减少。
    caption: 外用维 A 酸类(阿达帕林)作用示意动画
    status: ready
citations:
